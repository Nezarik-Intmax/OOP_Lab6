...
public:
	PaintFigureBase* a;
	MyEventArgs(PaintFigureBase* a):a(a){}
};*/
...
public:
	...
	PaintHandler():type(0),color(System::Drawing::Color::Black){
		figures = gcnew MyContainer<PaintFigureBase>;
	}
	~PaintHandler(){delete(figures);}
	...
	MyContainer<PaintFigureBase>^ getContainer(){ return figures; }
